...
export const MessageContent = ({
  ...
  <div
    className={cn(
      "is-user:dark flex w-fit min-w-0 max-w-full flex-col gap-2 overflow-hidden text-sm leading-6",
      "group-[.is-user]:ml-auto group-[.is-user]:rounded-[var(--radius-surface)] group-[.is-user]:border group-[.is-user]:border-border/65 group-[.is-user]:bg-card/55 group-[.is-user]:px-4 group-[.is-user]:py-3 group-[.is-user]:text-foreground",
