        ...
        <TooltipProvider delayDuration={400} skipDelayDuration={100}>
          <HapticsProvider>
            ...
            <nav aria-label="Main" className="z-50 hidden h-11 shrink-0 items-center gap-6 border-b border-border/90 bg-background/95 px-6 font-sans backdrop-blur-sm md:flex">
              <Link
                href="/"
                className="rounded-[var(--radius-control)] px-2 py-1.5 text-sm font-semibold tracking-tight text-foreground no-underline transition-colors duration-fast hover:bg-accent/55"
              >
                AI2
              </Link>
              <Link
                href="/"
                className="rounded-[var(--radius-control)] px-2 py-1.5 text-sm font-medium text-muted-foreground no-underline transition-colors duration-fast hover:bg-accent/55 hover:text-foreground"
              >
                Threads
              </Link>
              <Link
